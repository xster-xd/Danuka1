...
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=izgVmC7R#88AjTD9QrE1LeYB_zFmlQYdkSoI27AxGBPtYWhoWs6g' : process.env.SESSION_ID,
...
ALIVE_MSG: process.env.ALIVE_MSG === undefined ? "*HEY I AM MADUWA 😍*" : process.env.ALIVE_MSG,
...
WELCOME_GOODBYE: process.env.WELCOME_GOODBYE === undefined ? "tru" : process.env.WELCOME_GOODBYE,
